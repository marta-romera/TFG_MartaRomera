...
home = cd;
dirname = cd([cd,'\Resultats2'])% directorio on es trobarem els arxius .mat
filename = 'TFG_Marta2'; % nom del fitxer on es guarden els resultats
[FS,errorfiles] = RadiomicsTA2_2D(dirname, filename,'MRscan')
